  const slides = [
    ...
    { bg:"#9900cc", fg:"#ffffff", video:"assets/videos/video6_web.mp4", logo:"assets/iconos/MDW_DISEÑO_MODAS.png", title:'<span class="cat-thin">Categoría</span> <span class="cat-medium">Diseño de Modas</span>', catSize:"0.62em", desc:"La moda es expresión, identidad y cultura. Esta categoría celebra a los diseñadores textiles y de vestuario que combinan tradición artesanal con tendencias contemporáneas, creando propuestas que redefinen la estética y el consumo responsable." },
